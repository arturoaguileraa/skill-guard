...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: a form-control grouping wrapper, not a fieldset.
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: an input adornment wrapper, not a fieldset.
		// biome-ignore lint/a11y/useKeyWithClickEvents: click only forwards focus to the control; the control itself remains keyboard-accessible.
		<div
			role="group"
